...
router.get('/courses', function(req, res, next) {
  ...
  router.post('/courses', mid.authentication, function(req, res, next) {
  ...
  router.put('/courses/:courseId', mid.authentication, function(req, res, next) {
  ...
  router.post('/courses/:courseId/reviews', mid.authentication,   function(req, res, next) {
